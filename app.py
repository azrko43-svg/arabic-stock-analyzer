...
# تكوين الصفحة
st.set_page_config(
    page_title="محلل الأسهم الفني",
    page_icon="📈",
    layout="wide"
)

# تعريب العنوان
st.markdown("<h1 style='text-align: center;'>محلل الأسهم الفني</h1>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center;'>أداة للتحليل الفني للأسهم بالعربية</h3>", unsafe_allow_html=True)
